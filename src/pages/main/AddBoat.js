...
export default function AddBoat () {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(API_URL + '/add_boat_admin_side', formData)
      .then(response => {
      ...
      <PageLayout>
        <Col xl={12}>
          <div className='mc-card'>
            <div className='mc-breadcrumb'>
              <h3 className='mc-breadcrumb-title'>{t('Add Boat')}</h3>
              <ul className='mc-breadcrumb-list'>
                ...
                <li className='mc-breadcrumb-item'>{t('Add Boat')}</li>
              </ul>
            </div>
          </div>
        </Col>
        ...
        <Modal show={alertModal} onHide={() => setAlertModal(false)} centered>
          <div className='mc-alert-modal'>
            ...
            <h3>Confirmation</h3>
            <p>Boat has been created successfully.</p>
          </div>
        </Modal>
      </PageLayout>
    </>
