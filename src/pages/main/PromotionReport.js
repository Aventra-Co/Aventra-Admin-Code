...
export default function PromotionReport() {
    ...
    const fetchUserDetails = () => {
        ...
        axios
            .post(API_URL + '/promotion_tabular_report', {
                from_date: fromDate,
                to_date: toDate
            })
            .then(response => {
                ...
                if (response.data.success) {
                    setUserDetails(response.data.promotion_arr || [])
                } else {
    ...
    const exportToExcel = () => {
        ...
        saveAs(blob, 'PromotionReport.xlsx')
    }
    return (
        <PageLayout>

            <Helmet>
                <title>Aventra | Promotion-Report</title>
            </Helmet>
            <Col xl={12}>
                <div className='mc-card'>
                    <div className='mc-breadcrumb'>
                        <h3 className='mc-breadcrumb-title'>{t('Promotion Report')}</h3>
                        <ul className='mc-breadcrumb-list'>
                            ...
                            <li className='mc-breadcrumb-item'>{t('promotion list')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
            <div className='mc-card p-lg-4'>
                <Col xl={12}>
                    <Card.Header>
                        <Card.Title as='h5'>{t('Promotion Report')}</Card.Title>
                    </Card.Header>
                    <br />
                    <Card.Body>
                        <Row>
                                    ...
                                    <>
                                        ...
                                        {userDetails?.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>{item.start_time || 'NA'}</td>
                                                <td>{item.end_time || 'NA'}</td>
