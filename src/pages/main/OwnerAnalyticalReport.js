...
export default function OwnerAnalyticalReport() {
    ...
    useEffect(() => {
        axios
            .get(API_URL + '/get_owner_analytics_report', {
                params: { action: 'get_owner_analytics_report' }
            })
            .then((res) => {
                console.log('UserCount response:', res.data);
    ...
    return (
        <PageLayout>
            <Helmet>
                <title>Aventra | Owner-Analytical-Report</title>
            </Helmet>
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('owner_analytical_report')}</h3>
