...
import ManageFaqTableComponent from "../../components/tables/ManageFaqTableComponent";
...
export default function FaqPage() {
    ...
    return (
        <PageLayout>
            <Helmet>
                <title>Aventra | Manage-FAQ</title>
            </Helmet>
            <Row>
                <Col xl={12}>
                    <div className="mc-card">
                        <div className='mc-breadcrumb'>
                            <h3 className="mc-breadcrumb-title">{t('manage city')}</h3>
                            <ul className="mc-breadcrumb-list">
                                ...
                                <li className="mc-breadcrumb-item">{t('city list')}</li>
                            </ul>
                        </div>
                    </div>
                </Col>
                <Col xl={12}>
                    <div className="mc-card">
                        <div className="mc-card-header">
                            <h4 className="mc-card-title">{t('manage city')}</h4>
                        </div>


                        <ManageFaqTableComponent
