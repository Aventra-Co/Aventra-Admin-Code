...
export default function AddRole() {
    ...
    const handlesubmit = () => {
        ...
        axios.post(API_URL + '/add_role', formData).then((response) => {
        ...
        <PageLayout>
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('Add Role')}</h3>
                        <ul className="mc-breadcrumb-list">
                            <li className="mc-breadcrumb-item"><Link to={`${APP_PREFIX_PATH + '/dashboard'}`} className="mc-breadcrumb-link">{t('home')}</Link></li>
                            <li className="mc-breadcrumb-item"><Link to={`${APP_PREFIX_PATH + '/manage-role'}`} className="mc-breadcrumb-link">{t('role')}</Link></li>
                            <li className="mc-breadcrumb-item">{t('add role')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
            ...
            <Modal show={alertModal} onHide={() => setAlertModal(false)}>
                <div className="mc-alert-modal">
                    ...
                    <p>Role has been created successfully.</p>
                    <Modal.Footer>
                    </Modal.Footer>
                </div>
            </Modal >
