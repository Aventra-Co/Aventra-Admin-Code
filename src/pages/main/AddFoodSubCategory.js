...
export default function AddFoodSubCategory() {
    ...
    const handlesubmit = () => {
        ...
        //     food_sub_category_english: categoryEnglish,
        //     food_sub_category_arabic: categoryArabic,
        //     food_sub_category_french: categoryFrench,
        //     food_sub_category_italian: categoryItalian,
        //     food_sub_category_korean: categoryKorean,
        //     food_sub_category_image: image
        // }

        axios.post(API_URL + '/add_food_sub_category', formData).then((response) => {
        ...
        <PageLayout>
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('Add Food Sub-Category')}</h3>
                        <ul className="mc-breadcrumb-list">
                            ...
                            <li className="mc-breadcrumb-item">{t('Add Food Sub-Category')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
            ...
            <Modal show={alertModal} onHide={() => setAlertModal(false)}>
                <div className="mc-alert-modal">
                    ...
                    <p>Food sub-category added successfully.</p>
                    <Modal.Footer>
                    </Modal.Footer>
                </div> 
            </Modal >
