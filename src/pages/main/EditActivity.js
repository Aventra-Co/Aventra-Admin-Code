...
export default function EditActivity() {
    ...
    useEffect(() => {
        axios.get(API_URL + `/fetch_activity_by_id?activity_id=${activity_id}`).then((res) => {
            setactivityEnglish(res.data.activity_arr[0].activity_english)
            setactivityArabic(res.data.activity_arr[0].activity_arabic)
            setactivityFrench(res.data.activity_arr[0].activity_french)
            setactivityItalian(res.data.activity_arr[0].activity_italian)
            setactivityKorean(res.data.activity_arr[0].activity_korean)
        }).catch((error) => {
            console.log(error);
    ...
    const handlesubmit = () => {
        ...
        axios.post(API_URL + '/edit_activity', formData).then((response) => {
            ...
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('Edit Water Activity')}</h3>
                        <ul className="mc-breadcrumb-list">
                            ...
                            <li className="mc-breadcrumb-item">{t('Edit Water Activity')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
