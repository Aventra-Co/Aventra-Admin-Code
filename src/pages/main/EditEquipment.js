...
export default function EditEquipment() {
    ...
    const handlesubmit = () => {
        ...
        axios.post(API_URL + '/edit_equipment', formData).then((response) => {
    ...
    useEffect(() => {
        axios.get(API_URL + `/fetch_equipment_by_id?equipment_id=${equipment_id}`).then((res) => {
            setequipmentEnglish(res.data.equipment_arr[0].equipment_english)
            setequipmentArabic(res.data.equipment_arr[0].equipment_arabic)
            setequipmentFrench(res.data.equipment_arr[0].equipment_french)
            setequipmentItalian(res.data.equipment_arr[0].equipment_italian)
            setequipmentKorean(res.data.equipment_arr[0].equipment_korean)
        }).catch((error) => {
            console.log(error);
            ...
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('Edit Equipment')}</h3>
                        <ul className="mc-breadcrumb-list">
                            ...
                            <li className="mc-breadcrumb-item">{t('Edit Equipment')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
