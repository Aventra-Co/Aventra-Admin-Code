...
export default function AddTripType() {
    ...
    const handlesubmit = () => {
        ...
        if (!vectorImage) {
            errors.vectorImage = 'Please upload a vector image'
        }
        // if (!tripTypeFrench) {
        ...
        axios.post(API_URL + '/add_trip_type', formData).then((response) => {
    ...
    return (
        <PageLayout>
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('Add Activity')}</h3>
                        <ul className="mc-breadcrumb-list">
                            ...
                            <li className="mc-breadcrumb-item">{t('add Activity')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
            <div className="container">
                ...
                <div className='row m-2'>
                    <div className='col-md-6'>
                        ...
                        <Form.Control
                            ...
                            onChange={(e) => {
                                ...
                                setTripError((prev) => ({ ...prev, image: "" }));
                            }}
                            isInvalid={TripError.image}
                        />
                        <Form.Control.Feedback type="invalid">
                            {TripError.image}
                        </Form.Control.Feedback>
                    ...
                    <div className='col-md-6'>
                        ...
                        <Form.Control
                            ...
                            id="vectorImage"
                            onChange={(e) => {
                                setVectorImage(e.target.files[0]);
                                setTripError((prev) => ({ ...prev, vectorImage: "" }));
                            }}
                            isInvalid={TripError.vectorImage}
                        />
                        <Form.Control.Feedback type="invalid">
                            {TripError.vectorImage}
                        </Form.Control.Feedback>
                    </div>
                </div>
                ...
                > {loading ? <BeatLoader color="#fff" size={8} /> : 'ADD'}
                </button>
            </div>
