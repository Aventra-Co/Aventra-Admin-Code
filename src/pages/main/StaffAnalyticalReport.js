...
export default function StaffAnalyticalReport() {
    ...
    useEffect(() => {
        axios
            .get(API_URL + '/get_staff_analytics_report', {
    ...
    return (
        <PageLayout>
            <Helmet>
                <title>Aventra | Staff-Analytical-Report</title>
            </Helmet>
            <Col xl={12}>
                <div className="mc-card">
                    <div className='mc-breadcrumb'>
                        <h3 className="mc-breadcrumb-title">{t('Staff Analytical Report')}</h3>
                        <ul className="mc-breadcrumb-list">
                            ...
                            <li className="mc-breadcrumb-item">{t('Staff Analytical Report')}</li>
                        </ul>
                    </div>
                </div>
            </Col>
            <Typography
                ...
                gutterBottom
            >
                {t("Monthly Analytical Report of Staff")}
            </Typography>
            ...
            <Grid container>
                ...
                <Typography className="" style={{ margin: '40px auto 0px', color: '#000' }} variant="h5" gutterBottom>
                    {t("Yearly Analytical Report of Staff")}
                </Typography>
